...
import { AlertTriangle, X, ThumbsUp, ThumbsDown, Loader2, MapPin, Bell, CheckCircle2 } from "lucide-react";
...
function Header({ onReportClick, alertCount, onClearAlerts }) {
  return (
...
export default function App() {
  ...
  return (
    <div className="app-root">
      ...
      <Header onReportClick={handleReportClick} alertCount={newAlertCount} onClearAlerts={() => setNewAlertCount(0)} />
      <CategoryFilterBar active={activeCats} onToggle={toggleCat} />

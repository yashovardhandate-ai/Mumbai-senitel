...
export const STRINGS = {
  ...
  "inc.share": { en: "Share", hi: "साझा करें", mr: "शेअर करा" },
  "inc.linkCopied": { en: "Link copied", hi: "लिंक कॉपी हुआ", mr: "लिंक कॉपी झाली" },
  "inc.shareText": { en: "Incident reported on Mumbai Sentinel", hi: "मुंबई सेंटिनल पर दर्ज घटना", mr: "मुंबई सेंटिनेलवर नोंदवलेली घटना" },
  ...
  "haz.accident": { en: "Accident blackspots", hi: "दुर्घटना संभावित स्थान", mr: "अपघातप्रवण ठिकाणे" },
  "haz.bridge": { en: "Unsafe bridges", hi: "असुरक्षित पुल", mr: "असुरक्षित पूल" },
  "haz.building": { en: "Dangerous buildings", hi: "खतरनाक इमारतें", mr: "धोकादायक इमारती" },
